...
document.getElementById("divs").addEventListener("click",o3);
...
function clear() {
	let sumado =document.getElementById('display').innerHTML = ''
  }
...
function o3() {
	let actual = document.getElementById('display').innerHTML;
	let sumado = document.getElementById("divs").innerHTML;
	document.getElementById('display').innerHTML = actual + sumado
}
...
function showResult() {
	...
	if (suma !== -1) {
		...
		res = arr[0] * arr[1];
		document.getElementById("rdisplay").innerHTML = res;
